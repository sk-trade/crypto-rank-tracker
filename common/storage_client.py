...
async def load_json(filename: str, gcs_client = None) -> Optional[Union[List, Dict]]:
...
async def _load_json_from_gcs(gcs_client, filename: str) -> Optional[Union[List, Dict]]:
    try:
