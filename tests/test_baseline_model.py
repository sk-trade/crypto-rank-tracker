...
def test_baseline_model_uses_only_predecision_features_and_directional_outcomes():
    ...
    for index in range(40):
        ...
        events.append(ScanEvent(event_id=str(index), observed_at=now, market="KRW-A", feature_snapshot=snapshot, candidate_eligible=True, rejection_reasons=[], final_decision=ScanDecision.ALERT_SELECTED, model_version="test"))
